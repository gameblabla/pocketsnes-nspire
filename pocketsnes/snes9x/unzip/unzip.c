 ...
 */
extern int ZEXPORT 
unzString_textFileNameCompare (const char *fileName1, const char *fileName2, int iCaseSensitivity)
{
 ...
 * signification, see unzipString_textFileNameCompare
 * 
	       ...
	       int iCaseSensitivity)
{
	...
	unzGetCurrentFileInfo (file, NULL,
			  szCurrentFileName, sizeof (szCurrentFileName) - 1,
			       NULL, 0, NULL, 0);
	if (unzString_textFileNameCompare (szCurrentFileName,
