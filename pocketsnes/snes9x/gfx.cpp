...
static void S9xDisplayString_text (const char *string);
...
bool8 S9xGraphicsInit ()
{
    ...
    //GFX.InfoString_textTimeout = 0;
    //GFX.InfoString_text = NULL;
...
{
    if (GFX.InfoString_textTimeout > 0 && --GFX.InfoString_textTimeout == 0)
		GFX.InfoString_text = NULL;
...
void S9xEndScreenRefresh ()
{
    ...
    if (IPPU.RenderThisFrame)
	{
		...
		if (GFX.InfoString_text)
		{
			S9xDisplayString_text (GFX.InfoString_text);
			cprintf("%s:%d\n", __FILE__, __LINE__);
		}
#endif
...
void S9xSetInfoString_text (const char *string)
{
    GFX.InfoString_text = string;
    GFX.InfoString_textTimeout = 120;
}
